...
/** @type {string} */
const CACHE_VERSION = '1772036201|1771874004';
/** @type {string} */
const CACHE_PREFIX = 'Neon pong-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'NeonPong.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["NeonPong.html","NeonPong.js","NeonPong.offline.html","NeonPong.icon.png","NeonPong.apple-touch-icon.png","NeonPong.audio.worklet.js","NeonPong.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["NeonPong.wasm","NeonPong.pck"];
