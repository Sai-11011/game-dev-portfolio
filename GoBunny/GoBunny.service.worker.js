...
/** @type {string} */
const CACHE_VERSION = '1771743883|3863043396';
/** @type {string} */
const CACHE_PREFIX = 'Cyborg bun-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'GoBunny.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["GoBunny.html","GoBunny.js","GoBunny.offline.html","GoBunny.icon.png","GoBunny.apple-touch-icon.png","GoBunny.audio.worklet.js","GoBunny.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["GoBunny.wasm","GoBunny.pck"];
