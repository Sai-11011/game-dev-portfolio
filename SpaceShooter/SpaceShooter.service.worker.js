...
/** @type {string} */
const CACHE_VERSION = '1772993175|3391734627';
/** @type {string} */
const CACHE_PREFIX = 'Space Shooter-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'SpaceShooter.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["SpaceShooter.html","SpaceShooter.js","SpaceShooter.offline.html","SpaceShooter.icon.png","SpaceShooter.apple-touch-icon.png","SpaceShooter.audio.worklet.js","SpaceShooter.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["SpaceShooter.wasm","SpaceShooter.pck"];
